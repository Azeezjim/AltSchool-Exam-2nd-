    ...
    <div>
      <Nav>
        ...
        <Navs className='navs'>
          ...
          <NavLink to='/counter1' className={({ isActive }) => (isActive && 'link')}>useCounter Counter</NavLink>

          <NavLink to='/counter2' className={({ isActive }) => (isActive && 'link')}>useReducer Counter</NavLink>
      ...
      {<Hnavs className={hamburger ? 'hnavs noshow' : 'hnavs show'}>
        ...
        <NavLink to='/counter1' className={({ isActive }) => (isActive && 'hlink')} onClick={() => setHamburger(true)}>useCounter Counter</NavLink>

        <NavLink to='/counter2' className={({ isActive }) => (isActive && 'hlink')} onClick={() => setHamburger(true)}>useReducer Counter</NavLink>
